        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="bg-gradient-to-r from-[#FFFF33] to-[#FFFF00] text-black px-4 py-3 rounded-lg flex items-center space-x-3 transform transition-all duration-300 hover:scale-105">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <div>
                  <div className="font-bold">Global Nominee</div>
                  <div className="text-sm opacity-80">Recognized worldwide for innovation</div>
                </div>
              </div>
              
              <div className="bg-gradient-to-r from-[#FFFF66] to-[#FFFF33] text-black px-4 py-3 rounded-lg flex items-center space-x-3 transform transition-all duration-300 hover:scale-105">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <div>
                  <div className="font-bold">Honorable Mention</div>
                  <div className="text-sm opacity-80">Excellence in agricultural technology</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-slate-700/50 rounded-lg p-5 border border-[#FFFF33]/20 hover:border-[#FFFF33]/40 transition-all duration-300">
                <div className="flex items-start space-x-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#FFFF33] to-[#FFFF00] rounded-full flex items-center justify-center text-black font-bold text-lg">
                    ME
                  </div>
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-slate-800/60 to-slate-900/60 backdrop-blur-sm rounded-xl p-8 border border-[#FFFF33]/20">
            <div className="text-center">
              ...
              <div className="mt-6 inline-flex items-center space-x-2 text-[#FFFF33]">
                <Trophy className="w-5 h-5" />
                <span className="font-semibold">Recognized by NASA Goddard Space Flight Center</span>
              </div>
            </div>
          </div>
        </div>
