      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-lg p-4">
            ...
            <div className="bg-gradient-to-r from-[#FFFF00]/20 to-[#FFAA00]/20 border border-[#FFFF33]/30 rounded-xl p-4 mb-4 backdrop-blur-sm">
              <div className="text-center mb-4">
                ...
                <p className="text-gray-300">Leveraging Earth Observation Data for Informed Agricultural Decision-Making</p>
              </div>
            </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-lg p-4">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-[#FFFF33] flex items-center justify-center space-x-3">
