// filepath: /Users/xainkhan/Downloads/SpaceappschallengeV2-main/src/data/challenges.ts
...
export const constellations: Constellation[] = [
  {
    ...
    color: '#00D4FF',
    position: [10, 0, -8],
    description: 'Harness AI and big data analytics to unlock insights from NASA datasets.',
    challenges: challenges.filter(c => c.category === 'AI & Big Data')
  },
  {
    id: 'earth-climate',
    name: 'Earth & Climate', 
    theme: 'Our Living Planet',
    color: '#22C55E',
    position: [-8, 2, 5],
    description: 'Explore Earth\'s climate through satellite observations.',
    challenges: challenges.filter(c => c.category === 'Earth & Climate')
  }
];